        ...
        switch(this.state.instructionPageTest1){
                ...
                return(
                    <div> 
                      <div id="instructionPage1" className="instructionsPage"  >
                        ...
                        <button className="myButton"  style={{outline: 'none',marginLeft: '1.5rem'}} onClick={this.test1MainPage} >Previous</button>
                        <button className="myButton"style={{outline: 'none',marginLeft: '1.5rem'}} onClick={this.nextInstruction} >Next</button>
                    </div>
                  </div>
                )
              }
          case 2:{
            return(
              ...
              <button className="myButton" style={{outline: 'none',marginLeft: '1.5rem'}} onClick={this.lastInstruction} >Previous</button>
              <button className="myButton" style={{outline: 'none',marginLeft: '1.5rem'}} onClick={this.nextInstruction} >Next</button>
          ...
          case 4:{
            return(
              <div id="instructionPage4" className="instructionsPage">
                ...
                <button className="myButton" style={{outline: 'none',marginLeft: '1.5rem'}} onClick={this.lastInstruction} >Previous</button>
                <button className="myButton" style={{outline: 'none',marginLeft: '1.5rem'}} onClick={this.nextInstruction} >StartTest</button>
                <button className="myButton" style={{outline: 'none',marginLeft: '1.5rem'}} onClick={this.startDemoTest1 } >Start Demo</button>
              </div>
            )
          }
          //first stage
